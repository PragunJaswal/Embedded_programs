...
const char* ssid = "Scrolling board";
...
void handle_Incoming_Text() {
  ...
  // "MSG:" is the keyword to set the text to be displayed.
  // So even if the IP of Nodemcu is known to other people, he can not immediately set the text.
  if (Incoming_Text.substring(0,4) == "MSG:") {
    Text_To_EEPROM = Incoming_Text.substring(4, Incoming_Text.length());
    delay(10);
...
// Disp.drawText(1, 0, "JNGEC"); //--> Display text "Disp.drawText(x position, y position, text)"
  Scrolling_Text(2, 50); //--> Show running text "Scrolling_Text(y position, speed);"
}
//========================================================================
