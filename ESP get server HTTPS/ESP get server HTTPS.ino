...
const char*  server = "www.cloudflare.com";  // Server URL
...
void loop() {
  ...
  if (!client.connect(server, 443))
    ...
    client.println("GET https://v2.jokeapi.dev/joke/Programming HTTP/1.0");
    client.println("Host: www.cloudflare.com");
